<?php
    ...
    $q="select * from products where category='camera' and category is not null and name is not null and mname is not null and speci is not null and ratings is not null and price is not null limit 0,50;";
